    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=40, null=True, verbose_name='Plan Title')),
                ...
                ('slug', models.SlugField(default=models.CharField(max_length=40, null=True, verbose_name='Plan Title'), unique=True)),
            ],
        ),
    ]
